...
- Large-scale JSON ingestion from AWS S3  
- Implemented **SCD Type 2 with Delta Lake**  
- Designed **Star Schema (Fact & Dimension Tables)**  
🔗 [Repo Link](https://github.com/shreeharshahegde098/customer_order_endToEnd_data_pipeline)

---

### 🔹 API-Based Data Pipeline
- Real-time ingestion from external APIs  
- PySpark transformations for analytics  
- Near real-time reporting pipeline  
🔗 [Repo Link](https://github.com/shreeharshahegde098/API_Data_Pipeline)
...
🔗 [Repo Link](https://github.com/shreeharshahegde098/Sales_Analysis)

---

### 🔹 E-Commerce Data Analysis
- Designed relational schema in PostgreSQL  
- Performed SQL-driven business insights  
🔗 [Repo Link](https://github.com/shreeharshahegde098/E_Commerce_Project_PSQL)
